<template>
    <div>
        <gdpr-modal :toggleModal="toggleModal" v-if="!showMoreInfoTab">
            ...
            <template v-slot:footer>
                <button type="button" class="cookie-consent_modal__button cookie-consent_modal__button-default" @click="showMoreInfoTab = true">
                  More information
                </button>
                <button type="button" class="cookie-consent_modal__button cookie-consent_modal__button-primary" @click="allowAll">
                  Accept cookies
                </button>
            </template>
        </gdpr-modal>

        <gdpr-modal :toggleModal="toggleModal" v-else>
            <template v-slot:header>
            ...
            <template v-slot:footer>
                <button type="button" class="cookie-consent_modal__button cookie-consent_modal__button-default" @click="allowAll">
                  Allow all
                </button>
                <button type="button" class="cookie-consent_modal__button cookie-consent_modal__button-primary" @click="saveConsent">
                  Save settings
                </button>
            </template>
        </gdpr-modal>
...
<script>
    ...
    import { has, forEach, isNull, isUndefined, isObject, chain, split, trim, find } from 'lodash';
        ...
        methods: {
            ...
            isPageExcluded(page) {
                return ! chain(this.excludePages)
                        .split(',')
                        .find((exPage) => { return trim(exPage) === page; })
