...
import { forEach, has, isEmpty, isNull, isString, isArray, flatMap, flatten } from 'lodash';
...
export default {
    ...
    addScriptToDOM(script, documentFragment) {
        ...
        if(script.hasAttribute('src')) {
            postscribe(script.parentNode, '<script data-gdpr-target="' + script.getAttribute(OPTIONS.categorySelector) + '" src="' + script.getAttribute("src") + '"></script>');
            return;
        }
