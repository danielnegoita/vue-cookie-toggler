...
var iframes = {
  ...
  getAll() {
    ...
    return lodash.flatMap(iframesByCategories, iframe => {
      return iframe;
    });
  },
  ...
  getByCategories(categories) {
    ...
    let result = [];
    lodash.forEach(categories, category => {
  ...
  removePlaceholder(iframe) {
    const src = iframe.getAttribute(OPTIONS$1.srcSelector);
...
var scripts = {
  ...
  getAll() {
    ...
    return lodash.flatMap(scriptsByCategories, script => {
      return script;
    });
  },
  ...
  addScriptToDOM(script, documentFragment) {
    ...
    lodash.forEach(script.attributes, attrib => {
      if (attrib.specified) {
...
/* template */
var __vue_render__$3 = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('label',{class:_vm.classObject},[(_vm.shouldShowLabel)?_c('span',{staticClass:"vue-switcher__label"},[(_vm.label)?_c('span',{domProps:{"textContent":_vm._s(_vm.label)}}):_vm._e(),_vm._v(" "),(!_vm.label && _vm.value)?_c('span',{domProps:{"textContent":_vm._s(_vm.textEnabled)}}):_vm._e(),_vm._v(" "),(!_vm.label && !_vm.value)?_c('span',{domProps:{"textContent":_vm._s(_vm.textDisabled)}}):_vm._e()]):_vm._e(),_vm._v(" "),_c('input',{attrs:{"type":"checkbox","disabled":_vm.disabled},domProps:{"checked":_vm.value},on:{"change":_vm.trigger}}),_vm._v(" "),_c('div')])};
...
const __vue_scope_id__$2 = "data-v-4516241c";
/* module identifier */
...
const __vue_scope_id__$1 = "data-v-5c8186dc";
/* module identifier */
...
var script = {
  ...
  methods: {
    ...
    isPageExcluded(page) {
      return !lodash.chain(this.excludePages).split(',').find(exPage => {
    ...
    allowAll() {
      lodash.forEach(this.cookies, cookie => {
        cookie.allowed = true;
      });
      this.saveConsent();
    },
    ...
    getAllowedCategories() {
      ...
      lodash.forEach(this.getConsent(), cookie => {
        if (cookie.allowed) {
     ...
     */
    initListeners() {
      let elements = Array.from(document.querySelectorAll('[data-gdpr-action="showOptions"]'));
      lodash.forEach(elements, elem => {
